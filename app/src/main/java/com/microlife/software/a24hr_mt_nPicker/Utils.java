...
public class Utils
{
    ...
    public static void writeLogFile(List<byte[]> DataList)
    {
        ...
        Log.d(TAG, "writeLogFile(), log file: " + fileName);
        Log.d(TAG, "writeLogFile(), DataList size: " + DataList.size());
        try
        {
    ...
    public static ArrayList<Date> dtToSecond(ArrayList<byte[]> data)
    {
        ...
        //for(int i=0; i<40; i++)
        {
            ...
            //Log.d(TAG, "dtToSecond(), date[" + i + "]: " + sdf.format(tmpTime));
        ...
        Log.d(TAG, "dtToSecond(), dateList size:" + dateList.size() +
                ", dateList[0]: " + sdf.format(dateList.get(0)) +
    ...
    public static ArrayList<Integer> get180Records(ArrayList<Integer> srcList, int lastIndex)
    {
        ...
        Log.d(TAG, "get180Records(), indexList size:" + indexList.size() +
                ", indexList[0]: " + indexList.get(0) +
                ", indexList[" + (indexList.size() - 1) + "]: " + indexList.get(indexList.size()-1) );
    ...
    public static ArrayList<Integer> checkOver3Days(ArrayList<Date> dateList)
    {
        ...
        //    Log.d(TAG, "checkOver3Days(), indexList[" + j + "]: " + indexList.get(j) );
        //}

        Log.d(TAG, "checkOver3Days(), indexList size:" + indexList.size() +
                ", indexList[0]: " + indexList.get(0) +
                ", indexList[" + (indexList.size() - 1) + "]: " + indexList.get(indexList.size()-1) );
    ...
    public static ArrayList<Long> dtDeffrenceList(ArrayList<Date> data)
    {
        ...
        //for(int i=0; i<40; i++)
        {
            ...
            diffSecondList.add(tmpDiffSec);
            //System.out.printf("diff Sec[%02d]: %d%n", i, tmpDiffSec/1000);
            //Log.d(TAG, "dtDeffrenceList(), diffSecondList[" + i + "]: " + tmpDiffSec);
        }
